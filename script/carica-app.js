...
function carica(dir) {
  ...
  const espone = ["state", "BRAWLERS", "MAPS", "MODES", "MATCHUPS", "BRAWLER_OVERALL",
    ...
    "edgeCentrato", "advReale", "wrReale", "sinergiaReale", "sinergiaWrReale", "mxClasseAdv", "forzaReale", "sommaTabellone", "probabilitaTabellone", "calibrazioneModo", "mxModo", "mxPos", "mxK", "mxArr", "MATRICE", "MX_VUOTO", "scartoForzaAvversario", "forzaTipicaMappa", "viciniMisurati", "likelyEnemyPicks", "residualRisk", "favoreMatchup", "schierabile",
    "filtroAttivo", "usedNames", "currentTurn", "nomeDelTurno", "contenitore", "PROFILO", "QUOTA_RISPOSTA", "MAP_TRAIT_CLASS_BONUS", "searchRank", "ridotto", "rispostaMigliore"];
